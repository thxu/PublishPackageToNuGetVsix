//------------------------------------------------------------------------------
// <copyright file="PublishCommandPackage.cs" company="Company">
...
namespace PublishPackageToNuGet2015
{
    /// <summary>
    ...
    public sealed class PublishCommandPackage : Package
    {
        ...
        /// </summary>
        public const string PackageGuidString = "6514356a-8b5c-477f-8f26-6486097482c3";

        /// <summary>
        /// Initializes a new instance of the <see cref="PublishCommand"/> class.
        /// </summary>
        public PublishCommandPackage()
        {
